...
=end
      ...
      respond_to do |format|
        format.html
        format.nt { render body: HomosaurusV2.all_terms_full_graph(@terms).dump(:ntriples), :content_type => Mime::NT }
        format.jsonld { render body: HomosaurusV2.all_terms_full_graph(@terms).dump(:jsonld, standard_prefixes: true), :content_type => Mime::JSONLD }
        format.ttl { render body: HomosaurusV2.all_terms_full_graph(@terms).dump(:ttl, standard_prefixes: true), :content_type => Mime::TTL }
      end
    end
